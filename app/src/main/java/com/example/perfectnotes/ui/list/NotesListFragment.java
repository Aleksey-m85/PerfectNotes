package com.example.perfectnotes.ui.list;
...
import com.example.perfectnotes.domain.Note;
import com.example.perfectnotes.ui.NavigationDrawable;
import com.example.perfectnotes.ui.details.NoteDetailsFragment;
import com.example.perfectnotes.ui.details.NoteEditFragment;
import com.example.perfectnotes.ui.details.NotesRepositoryImpl;
...
public class NotesListFragment extends Fragment implements NotesListView, FragmentResultListener {
    ...
    public boolean onContextItemSelected(@NonNull MenuItem item) {
        ...
        NotesListAdapter listItem = (NotesListAdapter) adapter;
        int noteId = listItem.getLongClickNoteId();
